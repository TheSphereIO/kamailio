...
%package    jsdt
Summary:    JavaScript extensions for Kamailio.
Group:      System Environment/Daemons
Requires:   kamailio = %ver

%description    jsdt
JavaScript extensions for Kamailio.
...
%package    ss7ops
Summary:    Tools for handling M2UA/MTP-L3/ISUP 
Group:      System Environment/Daemons
Requires:   kamailio = %ver

%description    ss7ops
Tools for handling M2UA/MTP-L3/ISUP and convert it to JSON.
...
make
make every-module skip_modules="app_mono db_cassandra db_oracle \
    jabber ndb_cassandra osp" \
    group_include="kstandard kautheph kberkeley kcarrierroute kcnxcc kcpl \
    kgeoip kgzcompress khttp_async kims kjson kldap klua kmemcached \
    kmysql koutbound kperl kpostgres kpresence kpython \
